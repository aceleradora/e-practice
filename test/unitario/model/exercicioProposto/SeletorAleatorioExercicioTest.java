...
public class SeletorAleatorioExercicioTest {
    ...
    public void setUp() throws Exception {
        List <Exercicio> exerciciosQueEstariamNoBanco = new ArrayList<>();
    ...
    public void selecionaAleatoriamenteUmExercicio() throws Exception {
        ArrayList<Exercicio> lista1 = new ArrayList<>();
        ArrayList<Exercicio> lista2 = new ArrayList<>();
    ...
    @Test
    public void buscaExercicioNoBanco() throws Exception {
