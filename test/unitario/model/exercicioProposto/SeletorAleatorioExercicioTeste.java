...
public class SeletorAleatorioExercicioTeste {
    ...
    public void setUp() throws Exception {
        ...
        Exercicio exercicio1 = new Exercicio("exercicio 1", null);
        Exercicio exercicio2 = new Exercicio("exercicio 2", null);
        Exercicio exercicio3 = new Exercicio("exercicio 3", null);
        Exercicio exercicio4 = new Exercicio("exercicio 4", null);
